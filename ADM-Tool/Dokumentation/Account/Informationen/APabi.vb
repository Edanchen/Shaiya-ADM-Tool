...
Public Class APabi
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim cmd As Data.SqlClient.SqlCommand = New Data.SqlClient.SqlCommand("INSERT INTO ADM_Tool.dbo.Vorgaenge ([UserID],[Date],[Text],[Status],[Zugewiesenan], [Thema], [Art], [Type], [Erstelltdurch]) VALUES ('" & TextBox1.Text & "',DATEADD(year, +10, GETDATE()),'" & RichTextBox1.Text & "','" & ComboBox1.Text & "','" & ComboBox2.Text & "', 'Account', 'Information','AP abziehen', '" & Main.TextBox1.Text & "')", con)
        con.Open()
