...
Public Class CharLoginStatus
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim cmd As Data.SqlClient.SqlCommand = New Data.SqlClient.SqlCommand("UPDATE PS_GameData.dbo.Chars SET LoginStatus='0' WHERE CharName='" & ADM.TextBox25.Text & "'", con)
        con.Open()
        ...
        Try
            ...
            Do While reader1.Read()
                ...
                ADM.TextBox38.Text = (reader1("LoginStatus")
                )
                ADM.TextBox38.Text = IIf(ADM.TextBox38.Text = 0, "nein", "ja")
            Loop
