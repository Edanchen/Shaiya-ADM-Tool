...
Public Class Intelligenzändern
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim cmd As Data.SqlClient.SqlCommand = New Data.SqlClient.SqlCommand("UPDATE PS_GameData.dbo.Chars SET Int='" & TextBox1.Text & "' WHERE CharName='" & ADM.TextBox25.Text & "'", con)
        con.Open()
        ...
        If (sdr.Read() = True) Then
            ...
            Me.Hide()
        Else
            MessageBox.Show("Intelligenz erfolgreich geändert.")
            Me.Close()
        End If
        ...
        Try
            ...
            Do While reader1.Read()
                ...
                ADM.TextBox35.Text = (reader1("Int")
                )
            Loop
