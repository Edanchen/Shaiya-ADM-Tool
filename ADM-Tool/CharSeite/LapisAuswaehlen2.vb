...
Public Class LapisAuswaehlen2
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim cmd As Data.SqlClient.SqlCommand = New Data.SqlClient.SqlCommand("UPDATE PS_GameData.dbo.CharItems SET Gem3 = '" & ListView1.SelectedItems(0).SubItems(0).Text & "' WHERE ItemUID='" & TextBox2.Text & "'", con)
        con.Open()
        ...
        Try
            ...
            Do While reader1.Read()
                CharItembearbeiten.TextBox6.Text = (reader1("Gem3")
                )
            Loop
            reader1.Close()
            con1.Close()
