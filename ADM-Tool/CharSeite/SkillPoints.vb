...
Public Class SkillPoints
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim cmd As Data.SqlClient.SqlCommand = New Data.SqlClient.SqlCommand("UPDATE PS_GameData.dbo.Chars SET SkillPoint='" & TextBox1.Text & "' WHERE CharName='" & ADM.TextBox25.Text & "'", con)
        con.Open()
        ...
        If (sdr.Read() = True) Then
            ...
            Me.Hide()
        Else
            MessageBox.Show("SkillPoints erfolgreich geändert.")
            Me.Close()
        End If
        ...
        Try
            ...
            Do While reader1.Read()
                ...
                ADM.TextBox31.Text = (reader1("SkillPoint")
                )
            Loop
