...
Public Class Wiederbelebung
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim cmd As Data.SqlClient.SqlCommand = New Data.SqlClient.SqlCommand("UPDATE PS_GameData.dbo.Chars SET Del='0', Map='42', PosX='63', PosZ='57', DeleteDate=NULL WHERE CharName='" & ADM.TextBox25.Text & "'", con)
        con.Open()
        ...
        If (sdr.Read() = True) Then
            ...
            Me.Hide()
        Else
            MessageBox.Show("Char erfolgreich wiederbelebt.")
            Me.Close()
        End If
        ...
        Try
            ...
            Do While reader1.Read()
                ...
                ADM.TextBox29.Text = (reader1("Del")
                )
                ADM.TextBox29.Text = IIf(ADM.TextBox29.Text = 0, "nein", "ja")
            Loop
