...
Public Class GildenName

    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        Dim con As New Data.SqlClient.SqlConnection("Data Source=127.0.0.1,1433;Initial Catalog=PS_UserData;Trusted_Connection=Yes")
        Dim cmd As Data.SqlClient.SqlCommand = New Data.SqlClient.SqlCommand("UPDATE PS_GameData.dbo.Guilds SET GuildName='" & TextBox1.Text & "' WHERE GuildName='" & ADM.TextBox6.Text & "'", con)
        con.Open()
        ...
        If (sdr.Read() = True) Then
            ...
            Me.Hide()
        Else
            MessageBox.Show("GildenName erfolgreich geändert.")
            Me.Close()
        End If
        con.Close()
        ...
        con1.ConnectionString = "Data Source=127.0.0.1,1433;Initial Catalog=PS_UserData;Trusted_Connection=Yes"
        ...
        Try
            ...
            Do While reader1.Read()
                ADM.TextBox6.Text = (reader1("GuildName")
                )
