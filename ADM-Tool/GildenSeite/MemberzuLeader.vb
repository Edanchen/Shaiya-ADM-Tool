...
Public Class MemberzuLeader
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim cmd As Data.SqlClient.SqlCommand = New Data.SqlClient.SqlCommand("UPDATE PS_GameData.dbo.Guilds SET MasterUserID='" & TextBox2.Text & "', MasterCharID= '" & TextBox1.Text & "', MasterName= '" & TextBox3.Text & "' WHERE GuildID='" & ADM.TextBox5.Text & "'" &
                                                                             "UPDATE PS_GameData.dbo.GuildChars SET GuildLevel= '9' Where CharID='" & TextBox6.Text & "' AND GuildID= '" & ADM.TextBox5.Text & "'AND Del='0'" &
        ...
        cmd1.CommandText = "select GuildID, GuildName, MasterUserID, MasterName, MasterCharID, Del from PS_GameData.dbo.Guilds Where GuildID = '" & ADM.TextBox5.Text & "' AND Del='0'"
