...
Public Class GildenNachricht
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim cmd As Data.SqlClient.SqlCommand = New Data.SqlClient.SqlCommand("UPDATE PS_GameData.dbo.GuildDetails SET Remark='" & TextBox1.Text & "' WHERE GuildID='" & ADM.TextBox5.Text & "'", con)
        con.Open()
        ...
        If (sdr.Read() = True) Then
            ...
            Me.Hide()
        Else
            MessageBox.Show("Gilden Nachricht erfolgreich geändert.")
            Me.Close()
        End If
        con.Close()
        ...
        Try
            ...
            Do While reader1.Read()
                ADM.TextBox16.Text = (reader1("Remark")
                )
