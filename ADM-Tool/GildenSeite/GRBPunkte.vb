...
Public Class GRBPunkte
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim cmd As Data.SqlClient.SqlCommand = New Data.SqlClient.SqlCommand("UPDATE PS_GameData.dbo.Guilds SET GuildPoint='" & TextBox1.Text & "' WHERE GuildID='" & ADM.TextBox5.Text & "'", con)
        con.Open()
        ...
        If (sdr.Read() = True) Then
            ...
            Me.Hide()
        Else
            MessageBox.Show("GRB Punkte erfolgreich geändert.")
            Me.Close()
        End If
        con.Close()
        ...
        Try
            ...
            Do While reader1.Read()
                ADM.TextBox11.Text = (reader1("GuildPoint")
                )
