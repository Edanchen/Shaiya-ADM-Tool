...
Public Class Gildenhaus
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim cmd As Data.SqlClient.SqlCommand = New Data.SqlClient.SqlCommand("UPDATE PS_GameData.dbo.GuildDetails SET UseHouse='1' WHERE GuildID='" & ADM.TextBox5.Text & "'" &
                                                                             "UPDATE PS_GameData.dbo.GuildDetails SET BuyHouse='1' WHERE GuildID='" & ADM.TextBox5.Text & "'", con)
        con.Open()
        ...
        If (sdr.Read() = True) Then
            ...
            Me.Hide()
        Else
            MessageBox.Show("Gildenhaus erfolgreich geöffnet.")
            Me.Close()
        End If
        con.Close()
        ...
        Try
            ...
            Do While reader1.Read()
                ADM.TextBox13.Text = (reader1("UseHouse")
                )
                ADM.TextBox13.Text = IIf(ADM.TextBox13.Text = 0, "nein", "ja")
            Loop
