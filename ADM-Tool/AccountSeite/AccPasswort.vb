...
Public Class AccPasswort
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim cmd As Data.SqlClient.SqlCommand = New Data.SqlClient.SqlCommand("UPDATE PS_UserData.dbo.Users_Master SET PW='" & TextBox1.Text & "' WHERE UserID='" & ADM.TextBox18.Text & "'", con)
        con.Open()
        ...
        cmd1.CommandText = "select UserUID, PW from PS_UserData.dbo.Users_Master Where UserUID= '" & ADM.TextBox17.Text & "'"
        Try
            con1.Open()
            reader1 = cmd1.ExecuteReader()
            Do While reader1.Read()
                ADM.TextBox19.Text = (reader1("PW")
                )
