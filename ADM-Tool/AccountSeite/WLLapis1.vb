Public Class WLLapis1
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim cmd As Data.SqlClient.SqlCommand = New Data.SqlClient.SqlCommand("UPDATE PS_GameData.dbo.UserStoredItems SET Gem2 = '" & ListView1.SelectedItems(0).SubItems(0).Text & "' WHERE ItemUID='" & TextBox2.Text & "'", con)
        con.Open()
        ...
        Try
            ...
            Do While reader1.Read()
                AccWLbearbeiten.TextBox5.Text = (reader1("Gem2")
                )
            Loop
            reader1.Close()
            con1.Close()
